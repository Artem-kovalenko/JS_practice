// hoisting - JS при интерпретации файлы перемещает определение например функций в начало файла
// мы можем обратить к ним до того, как определили
